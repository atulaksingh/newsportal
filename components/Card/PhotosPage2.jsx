          ...
          <div className="relative  -mt-52  ">
            ...
            <h4 className="text-white line-clamp-5 xl  bg-gradient-to-t from-black via-neutral-900 to-transparent  h-44  mt-1  w-full box-border ">
              <div className="px-4 text-2xl font-bold leading-tight overflow-hidden">
                ...
                recusandae, inventore commodi cum aut dolor, laborum Lorem ipsum
                dolor sit amet consectetur adipisicing elit.bwdhbashbshdbhbLorem
                ipsum dolor sit amet consectetur adipisicing elit. Placeat
                recusandae, inventore commodi cum aut dolor, laborum Lorem ipsum
                dolor sit amet consectetur adipisicing elit.bwdhbashbshdbhb
              </div>
            </h4>
          </div>
        </div>
